...
class UserMintinesView extends StatefulWidget {
  const UserMintinesView({super.key});

  @override
  State<UserMintinesView> createState() => _UserMintinesState();
}

class _UserMintinesState extends State<UserMintinesView> {
        ...
        trailing: ElevatedButton(
          onPressed: () {
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) =>
                    UserMintinesViewData(userReportId: userReportId),
              ),
            );
          },
