...
class ComputerCollage extends StatelessWidget {
  const ComputerCollage({super.key});
      ...
      body: Container(
        ...
        child: StreamBuilder(
          stream: FirebaseFirestore.instance
              ...
              .where(
                'selected_option',
                isEqualTo: ' كلية الحاسب الالي  جامعة ام القرى',
              )
              .snapshots(),
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    await launchUrl(
                        Uri.parse('https://maps.app.goo.gl/M9JJGtxZQsoQXAhs5'));
                  },
