...
class BusinessCollage extends StatelessWidget {
  const BusinessCollage({super.key});
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              //         'https://maps.app.goo.gl/NWkQJL1yov1DcdcGA'));
                              //   },
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    await launchUrl(
                        Uri.parse('https://maps.app.goo.gl/NWkQJL1yov1DcdcGA'));
                  },
                  style: ElevatedButton.styleFrom(
