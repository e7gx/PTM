...
class HistoryCollage extends StatelessWidget {
  const HistoryCollage({super.key});
        ...
        child: StreamBuilder(
          stream: FirebaseFirestore.instance
              ...
              .where('selected_option',
                  isEqualTo: "كلية الشريعة الإسلامية جامعة ام القرى")
              .snapshots(),
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    await launchUrl(
                        Uri.parse('https://maps.app.goo.gl/LgCH6KiLyjPVyPz89'));
                  },
