...
import '../user_report/user_reports.dart';
...
class AdminSolveReport extends StatefulWidget {
  const AdminSolveReport({super.key});
...
class _DeviceReportsState extends State<AdminSolveReport> {
                ...
                children: [
                  ElevatedButton.icon(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor:
                          sortByNewest ? Colors.redAccent : Colors.teal,
                  ...
                  ElevatedButton.icon(
                    ...
                    style: ElevatedButton.styleFrom(
                      padding: const EdgeInsets.symmetric(
                          horizontal: 30, vertical: 8),
                      backgroundColor: sortByOldest ? Colors.teal : Colors.teal,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(14.0),
                      ),
                    ),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          Text(
                                            '${S.of(context).it_all_reports_NumOReports}: ${reportData['reportNumber'] ?? S.of(context).user_reports_Erorr}',
                                            style: const TextStyle(
                                                fontSize: 12.0,
                                                color: Colors.white),
                                          ),
                                          Text(
                                            '${S.of(context).it_reports_received_ReportDate} : ${DateFormat('dd/MM/yyyy').format(reportDate)}',
                                            style: const TextStyle(
                                                fontSize: 12.0,
                                                color: Colors.white),
                                          ),
                                          Text(
                                            '${S.of(context).it_reports_received_ReportLocation}  ${reportData['location'] ?? S.of(context).user_reports_Erorr}',
                                            style: const TextStyle(
                                              fontSize: 12.0,
                                              color: Colors.white,
                                            ),
