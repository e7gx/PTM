...
import 'show_reports_user_ditils.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          S.of(context).user_reports_UserReport,
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    S.of(context).user_reports_NoReport,
                    style: const TextStyle(
                        fontFamily: 'Cario',
                        color: Colors.teal,
                        fontSize: 23,
              ...
              return ReportCard(
                report: Report(
                  ...
                  location: reportData['location'] ??
                      S.of(context).user_reports_Undefined, // الموقع
    ...
    return Card(
      ...
      child: ListTile(
        ...
        trailing: ElevatedButton(
          ...
          child: Text(
            S.of(context).user_reports_ShowReport,
            style: const TextStyle(
