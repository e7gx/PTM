              ...
              children: [
                ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    backgroundColor:
                        sortByToday ? Colors.redAccent : Colors.teal,
                ...
                ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    padding:
                        const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
                    backgroundColor: sortByNewest ? Colors.red : Colors.teal,
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(14.0),
                    ),
                  ),
                ...
                ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    padding:
                        const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
                    backgroundColor: sortByOldest ? Colors.red : Colors.teal,
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(14.0),
                    ),
                  ),
